...
if("FALSE" STREQUAL "TRUE")
  set(pitt_object_table_segmentation_SOURCE_PREFIX /home/luca-phd/ros_ws/src/primitive_identification_tagging_and_tracking/pitt_object_table_segmentation)
  set(pitt_object_table_segmentation_DEVEL_PREFIX /home/luca-phd/ros_ws/src/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pitt_object_table_segmentation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Buoncompagni Luca <luca.buoncompagni@edu.unige.it>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/luca-phd/ros_ws/devel/lib;/opt/ros/indigo/lib)
