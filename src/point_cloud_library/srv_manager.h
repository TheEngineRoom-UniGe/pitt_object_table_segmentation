...
using namespace std;
	...
	const string PARAM_NAME_ARM_SRV_MIN_FOREARM_BOX  = "/pitt/service/arm_filter/min_forearm_box";
	const string PARAM_NAME_ARM_SRV_MAX_FOREARM_BOX  = "/pitt/service/arm_filter/max_forearm_box";
	const string PARAM_NAME_ARM_SRV_MIN_ELBOW_BOX  = "/pitt/service/arm_filter/min_elbow_box";
	const string PARAM_NAME_ARM_SRV_MAX_ELBOW_BOX  = "/pitt/service/arm_filter/max_elbow_box";
	...
	// the value (cross product -> 0) to descriminate if a vector is parallel to the ground given in the support service
